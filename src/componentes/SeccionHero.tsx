...
export const SeccionHero = () => {
  return (
    <section 
      id="inicio" 
      className="relative bg-auto-seguro-negro text-white pt-8 md:pt-16 lg:pt-20 pb-8 md:pb-20 px-4 md:px-6 lg:px-8 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6 md:gap-12 lg:gap-16 items-center relative z-10">
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="flex items-center gap-3 md:gap-4">
              <div className="w-7 h-7 md:w-8 md:h-8 bg-auto-seguro-rojo rounded-full flex items-center justify-center flex-shrink-0">
                <span className="text-white text-base md:text-lg">✓</span>
              </div>
              <div>
                <h3 className="text-base md:text-xl font-semibold">Protección antirrobo automática</h3>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <div>
                <h3 className="text-base md:text-xl font-semibold">Se bloquea solo si el control se aleja</h3>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <div>
                <h3 className="text-base md:text-xl font-semibold">Sin el control no arranca el motor</h3>
              </div>
            </div>
          </div>
